...
var attrOIDMap = map[radius.Type]radius.NameType{
	1:   {"Quintum-AVPair", 1, nil},
	2:   {"Quintum-NAS-Port", 1, nil},
	23:  {"Quintum-h323-remote-address", 1, nil},
	24:  {"Quintum-h323-conf-id", 1, nil},
	25:  {"Quintum-h323-setup-time", 1, nil},
	26:  {"Quintum-h323-call-origin", 1, nil},
	27:  {"Quintum-h323-call-type", 1, nil},
	28:  {"Quintum-h323-connect-time", 1, nil},
	29:  {"Quintum-h323-disconnect-time", 1, nil},
	30:  {"Quintum-h323-disconnect-cause", 1, nil},
	31:  {"Quintum-h323-voice-quality", 1, nil},
	33:  {"Quintum-h323-gw-id", 1, nil},
	35:  {"Quintum-h323-incoming-conf-id", 1, nil},
	101: {"Quintum-h323-credit-amount", 1, nil},
	102: {"Quintum-h323-credit-time", 1, nil},
	103: {"Quintum-h323-return-code", 1, nil},
	104: {"Quintum-h323-prompt-id", 1, nil},
	105: {"Quintum-h323-time-and-day", 1, nil},
	106: {"Quintum-h323-redirect-number", 1, nil},
	107: {"Quintum-h323-preferred-lang", 1, nil},
	108: {"Quintum-h323-redirect-ip-address", 1, nil},
	109: {"Quintum-h323-billing-model", 1, nil},
	110: {"Quintum-h323-currency-type", 1, nil},
}

var attrNameMap = map[string]radius.OIDType{
	"Quintum-AVPair":                   {1, 1, nil},
	"Quintum-NAS-Port":                 {2, 1, nil},
	"Quintum-h323-remote-address":      {23, 1, nil},
	"Quintum-h323-conf-id":             {24, 1, nil},
	"Quintum-h323-setup-time":          {25, 1, nil},
	"Quintum-h323-call-origin":         {26, 1, nil},
	"Quintum-h323-call-type":           {27, 1, nil},
	"Quintum-h323-connect-time":        {28, 1, nil},
	"Quintum-h323-disconnect-time":     {29, 1, nil},
	"Quintum-h323-disconnect-cause":    {30, 1, nil},
	"Quintum-h323-voice-quality":       {31, 1, nil},
	"Quintum-h323-gw-id":               {33, 1, nil},
	"Quintum-h323-incoming-conf-id":    {35, 1, nil},
	"Quintum-h323-credit-amount":       {101, 1, nil},
	"Quintum-h323-credit-time":         {102, 1, nil},
	"Quintum-h323-return-code":         {103, 1, nil},
	"Quintum-h323-prompt-id":           {104, 1, nil},
	"Quintum-h323-time-and-day":        {105, 1, nil},
	"Quintum-h323-redirect-number":     {106, 1, nil},
	"Quintum-h323-preferred-lang":      {107, 1, nil},
	"Quintum-h323-redirect-ip-address": {108, 1, nil},
	"Quintum-h323-billing-model":       {109, 1, nil},
	"Quintum-h323-currency-type":       {110, 1, nil},
}
...
func init() {
	attributemap.RegisterVendor(_Quintum_VendorID, GetAttrName, GetAttrOID)
}
