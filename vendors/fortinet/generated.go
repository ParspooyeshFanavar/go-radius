...
var attrOIDMap = map[radius.Type]radius.NameType{
	1: {"Fortinet-Group-Name", 1, nil},
	2: {"Fortinet-Client-IP-Address", 3, nil},
	3: {"Fortinet-Vdom-Name", 1, nil},
	4: {"Fortinet-Client-IPv6-Address", 2, nil},
	5: {"Fortinet-Interface-Name", 1, nil},
	6: {"Fortinet-Access-Profile", 1, nil},
}

var attrNameMap = map[string]radius.OIDType{
	"Fortinet-Group-Name":          {1, 1, nil},
	"Fortinet-Client-IP-Address":   {2, 3, nil},
	"Fortinet-Vdom-Name":           {3, 1, nil},
	"Fortinet-Client-IPv6-Address": {4, 2, nil},
	"Fortinet-Interface-Name":      {5, 1, nil},
	"Fortinet-Access-Profile":      {6, 1, nil},
}
...
func init() {
	attributemap.RegisterVendor(_Fortinet_VendorID, GetAttrName, GetAttrOID)
}
