...
func AscendSendSecret_Add(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _Ascend_AddVendor(p, 214, a)
}

func AscendSendSecret_AddString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AscendSendSecret_Get(p *radius.Packet) (value []byte) {
	value, _ = AscendSendSecret_Lookup(p)
	return
}

func AscendSendSecret_GetString(p *radius.Packet) (value string) {
	value, _ = AscendSendSecret_LookupString(p)
	return
}

func AscendSendSecret_Gets(p *radius.Packet) (values [][]byte, err error) {
	var i []byte
	for _, attr := range _Ascend_GetsVendor(p, 214) {
		i = radius.Bytes(attr)
		if err != nil {
			return
		}
...
func AscendSendSecret_GetStrings(p *radius.Packet) (values []string, err error) {
	var i string
	for _, attr := range _Ascend_GetsVendor(p, 214) {
		i = radius.String(attr)
		if err != nil {
...
func AscendSendSecret_Lookup(p *radius.Packet) (value []byte, err error) {
	a, ok := _Ascend_LookupVendor(p, 214)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func AscendSendSecret_LookupString(p *radius.Packet) (value string, err error) {
	a, ok := _Ascend_LookupVendor(p, 214)
	if !ok {
		err = radius.ErrNoAttribute
		return
...
func AscendSendSecret_Set(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _Ascend_SetVendor(p, 214, a)
}

func AscendSendSecret_SetString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AscendSendSecret_Del(p *radius.Packet) {
	_Ascend_DelVendor(p, 214)
}

func AscendReceiveSecret_Add(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _Ascend_AddVendor(p, 215, a)
}

func AscendReceiveSecret_AddString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AscendReceiveSecret_Get(p *radius.Packet) (value []byte) {
	value, _ = AscendReceiveSecret_Lookup(p)
	return
}

func AscendReceiveSecret_GetString(p *radius.Packet) (value string) {
	value, _ = AscendReceiveSecret_LookupString(p)
	return
}

func AscendReceiveSecret_Gets(p *radius.Packet) (values [][]byte, err error) {
	var i []byte
	for _, attr := range _Ascend_GetsVendor(p, 215) {
		i = radius.Bytes(attr)
		if err != nil {
			return
		}
...
func AscendReceiveSecret_GetStrings(p *radius.Packet) (values []string, err error) {
	var i string
	for _, attr := range _Ascend_GetsVendor(p, 215) {
		i = radius.String(attr)
		if err != nil {
...
func AscendReceiveSecret_Lookup(p *radius.Packet) (value []byte, err error) {
	a, ok := _Ascend_LookupVendor(p, 215)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func AscendReceiveSecret_LookupString(p *radius.Packet) (value string, err error) {
	a, ok := _Ascend_LookupVendor(p, 215)
	if !ok {
		err = radius.ErrNoAttribute
		return
...
func AscendReceiveSecret_Set(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _Ascend_SetVendor(p, 215, a)
}

func AscendReceiveSecret_SetString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func AscendReceiveSecret_Del(p *radius.Packet) {
	_Ascend_DelVendor(p, 215)
}
